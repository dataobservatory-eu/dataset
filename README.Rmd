...
The `dataset` package provides tools to create semantically rich and interoperable datasets in R. Semantically rich datasets that are easier to:
...
This ensures that, for example, "GDP" is always associated with a precise concept and unit, avoiding ambiguity across analyses and publications. See [defined: Semantically Enriched Vectors](https://dataset.dataobservatory.eu/articles/defined.html)
