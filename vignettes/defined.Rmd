...
attributes(gdp_1)
```
From this output it is clear that actual s3 class is called `haven_labelled_defined`, which clearly indicates the inheritance from `haven_labelled`. In the dataset summary headers the `<defined>` abbreviation is used.
