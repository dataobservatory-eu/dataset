...
-   A data manager of the dataset, in this case, the author of the pacakge; utilising the ORCiD permanent ID system for researchers;

-   The original publisher as *American Iris Society*

-   A permanent DOI identifier for the original published version as a souce;
...
As a reminder, in the beginning we definded our dataset description according to DCTERMS with the `dublincore()` constructor. We can partially convert this metadata to the DataCite definition:
