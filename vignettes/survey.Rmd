...
tiny_survey <- dataset (raw_survey, dataset_id = "sample_survey", 
         obs_id = "obs_id", dimensions = "geo", measurements = c("listen_spotify", "sex", "age_exact", "difficulty_bills"), Title = "Tiny Survey")
```
...
```{r}
tiny_survey_datacite <- datacite(tiny_survey, Title = "Tiny Survey", Creator = person("Daniel", "Antal"), Publisher = "Reprex", PublicationYear = 2022, Subject = "Surveys", Language = "en")
```
