...
Attributes that may vary across observations (rows) should remain in the dataset in the datacube model.
...
When joining data tables or working in a relational database, you need unique identifiers for each unique observation unit in your system. If you want to broaden the useability of your data to the entire semantic web, and use it as linked data, you need a truly unique identifier (URI) for each observation.
